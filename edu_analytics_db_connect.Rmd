...
edu_db_con %>%
  clean_deidentified(tbl_name = "school", 
      "study_id", "mod_school_desc", "program_type_desc") ->
  schools_clean_deid
...
edu_db_con %>%
  clean_deidentified(tbl_name = "mmi_scores", 
      "study_id", "appl_year", "interviewer_type",
      min_year = 2014) %>%
...
edu_db_con %>%
  clean_deidentified(tbl_name = "parent_guardian", 
      "study_id", "parent_id", "occupation_desc", "edu_level_desc", "gender") ->
  parents_clean_deid
