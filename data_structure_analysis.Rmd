...
# number of distinct categories for categorical variables by application year for
# list of tibbles

# get_ndistinct <- function()
...
get_cat_tables <- function(dat, varname, prop=T, digits = 3)   {
  big_tables <- initialize_cat_tables(dat, appl_year)
...
cat_tabs <- get_cat_tables(dat, appl_year, prop=T, digits=3)
...
get_basic_date_summaries(df_list = tbl, varname = appl_year)
