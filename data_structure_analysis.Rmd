...
get_basic_num_summaries_single(dat, appl_year)

get_basic_num_summaries(tbl, appl_year)
...
get_basic_summaries_single(appl, appl_year, is.POSIXct)

get_basic_summaries(df_list = tbl, appl_year, is.POSIXct)
