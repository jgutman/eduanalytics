...
#combine features with outcomes
residency_noncompete_admissions <- create_outcome_features_data(generated_features_admissions, residency_noncompete)

#write to database
model_run_name <- "residency_noncompete_admit"
...
```{r}
#combine features with outcomes
residency_noncompete_admissions_inschool <- create_outcome_features_data(generated_features_admissions_inschool, residency_noncompete)

#wrte to database
model_run_name <- "residency_noncompete_admit_inschool"
